...
const CONSULTAS = [
  ...
  { key: "pje_trf1", label: "PJE-TRF1", url: "https://pje1g-consultapublica.trf1.jus.br/consultapublica/ConsultaPublica/listView.seam", descricao: "PJe TRF1 - Consulta Pública" },
  { key: "trf1_secao_to", label: "TRF1-SEÇÃO-TO", url: "https://pje1g-consultapublica.trf1.jus.br/consultapublica/ConsultaPublica/listView.seam", descricao: "TRF1 Seção Judiciária do Tocantins" },
  { key: "trf1_araguaina", label: "TRF1-ARAGUAÍNA", url: "https://pje1g-consultapublica.trf1.jus.br/consultapublica/ConsultaPublica/listView.seam", descricao: "TRF1 Subseção Araguaína" },
  { key: "trf1_balsas", label: "TRF1-BALSAS", url: "https://pje1g-consultapublica.trf1.jus.br/consultapublica/ConsultaPublica/listView.seam", descricao: "TRF1 Subseção Balsas" },
  { key: "trf1_imperatriz", label: "TRF1-IMPERATRIZ", url: "https://pje1g-consultapublica.trf1.jus.br/consultapublica/ConsultaPublica/listView.seam", descricao: "TRF1 Subseção Imperatriz" },
  { key: "trf1_palmas", label: "TRF1-PALMAS", url: "https://pje1g-consultapublica.trf1.jus.br/consultapublica/ConsultaPublica/listView.seam", descricao: "TRF1 Subseção Palmas" },
  { key: "trf1_gurupi", label: "TRF1-GURUPI", url: "https://pje1g-consultapublica.trf1.jus.br/consultapublica/ConsultaPublica/listView.seam", descricao: "TRF1 Subseção Gurupi" },
